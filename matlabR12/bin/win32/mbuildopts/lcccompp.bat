...
set LINKFLAGSPOST=libmmfile.lib libmatlb.lib libmx.lib libmat.lib
set DLLLINKFLAGS=-dll "%LIB_NAME%.def" %LINKFLAGS% %LIB_NAME%_stub.obj
set DLLLINKFLAGSPOST=%LINKFLAGSPOST%
set HGLINKFLAGS=%LINKFLAGS%
set HGLINKFLAGSPOST=%LINKFLAGSPOST% sgl.lib libmwsglm.lib
set HGDLLLINKFLAGS=%DLLLINKFLAGS%
set HGDLLLINKFLAGSPOST=%DLLLINKFLAGSPOST% sgl.lib libmwsglm.lib
set LINKOPTIMFLAGS=
set LINKDEBUGFLAGS=
set LINK_FILE=
set LINK_LIB= 
