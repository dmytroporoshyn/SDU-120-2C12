...
rem
rem    $Revision: 1.21 $  $Date: 2000/08/26 05:29:16 $
rem
rem ********************************************************************
...
set LINKER=bcc32
set LINKFLAGS=-tWD -L%BORLAND%\lib\32bit -L%BORLAND%\lib -L%LIBLOC% libmx.lib libmex.lib libmatlbmx.lib libmat.lib
set LINKOPTIMFLAGS=
...
set POSTLINK_CMDS1=del "%MEX_NAME%.map"
