...
rem
rem    $Revision: 1.10 $  $Date: 2000/08/26 05:29:15 $
rem
rem ********************************************************************
...
set LINKFLAGS=-aa -c -Tpd -x -Gn -L\"%BORLAND%\"\lib\32bit -L\"%BORLAND%\"\lib -L\"%LIBLOC%\" libmx.lib libmex.lib libmatlbmx.lib libmat.lib c0d32.obj import32.lib cw32mt.lib "%OUTDIR%%MEX_NAME%.def"
set LINKOPTIMFLAGS=
