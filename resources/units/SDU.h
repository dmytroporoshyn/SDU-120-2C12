...
class TSDUSolver
{
    ...
    double tr,vr,tetar,N,dovorot,deltat1,deltat2,tn,tauaN,I1N,Kvrs,Xtn,teta0n,x0,y0,z0,D,v0,teta0,d,i,qo,tauoN,go,R,ltz,lq,PoN,dP,dtau,Wx,Wz,dvo,Tz,dq,dteta,eta,L,A,rteta0,rv0,rc,rw,rz,Bsh,ag,Omegaz,Rz;
